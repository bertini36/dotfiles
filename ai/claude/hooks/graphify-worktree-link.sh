#!/usr/bin/env bash
# Link the shared, gitignored graphify-out/ knowledge graph from the main repo
# into a git worktree so graphify queries work without rebuilding the graph.
set -euo pipefail
